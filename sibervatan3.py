...
surname = "Comart"
age = 15
karsilama = 'Benim adim ' + name + ' ' + surname + ' ' + 'yasim ' + str(age) + ' hosgeldin' 
print(karsilama) 
...
karsilama_find = karsilama.find("Azra")
...
karsilama_replace = karsilama.replace('Azra','Şevval')
